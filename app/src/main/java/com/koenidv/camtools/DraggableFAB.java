...
//  Created by koenidv on 26.01.2018, absolutely not just copied from Stack Overflow.
...
public class DraggableFAB extends FloatingActionButton implements View.OnTouchListener {
    ...
    public boolean onTouch(View view, MotionEvent motionEvent){
        ...
        if (action == MotionEvent.ACTION_DOWN) {
            ...
            newY = Math.min(parentHeight - viewHeight - 144, newY); // Don't allow the FAB past the bottom of the parent
